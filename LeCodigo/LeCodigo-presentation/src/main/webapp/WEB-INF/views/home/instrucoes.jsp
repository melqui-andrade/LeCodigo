<div style="margin-top: 6%;">
	<h4 class="cor-branco texto-centralizado ">Instruções</h4>
	<div class="container">
		<div class="panel">
			...
			<div class="panel-body" style="border-color: #fff;">
				<p>
					LeCodigo é um jogo para auxiliar no estudo a algoritmos.<br> O
					objetivo do jogo é responder corretamente as questões que serão
					...
					o jogador deverá acertar as 5 etapas da 1ª fase, e assim com a fase
					subsequente.<br>
				</p>
			</div>
		</div>
		...
		<div class="panel">
			<div class="panel-body" style="border-color: #fff;">
				<p>
					...
					Cada resposta errada diminuirá 1 bit a ser recebido, o valor mínimo
					de bit a ser ganho é 1.<br> Sendo que, uma questão correta
					vale:<br> <span class="negrito">* Na Fase 1:</span> 3 bits;<br>
					<span class="negrito">* Na Fase 2:</span> 5 bits;<br> <span
						class="negrito">* Na Fase 3:</span> 7 bits<br>
				</p>
			</div>
		</div>
	</div>
